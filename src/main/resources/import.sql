...
INSERT INTO album.images (title, visible, description, url)VALUES('cascata', 1, 'Una cascata nella parte nord-ovest dell\'Italia', 'https://picsum.photos/id/15/1920/1080');
...
INSERT INTO album.images (title, visible, description, url)VALUES('prato', 1, 'Un prato nella parte sud-est della Francia', 'https://picsum.photos/id/18/1920/1080');
...
INSERT INTO album.images (title, visible, description, url)VALUES('panchina', 1, 'Una panchina nella parte sud-ovest della Svizzera', 'https://picsum.photos/id/32/1920/1080');
INSERT INTO album.images (title, visible, description, url)VALUES('ponte', 1, 'Un ponte nella parte est dell\'America', 'https://picsum.photos/id/32/1920/1080');
